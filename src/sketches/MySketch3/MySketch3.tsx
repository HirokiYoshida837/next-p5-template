  ...
  return (
    <>
      ...
      <>
        ...
        pos X <input type="range" value={position.x} min="0" max="500" onChange={changeEllipsePosX}/>
        pos X <input type="range" value={position.y} min="0" max="500" onChange={changeEllipsePosY}/>
      </>
